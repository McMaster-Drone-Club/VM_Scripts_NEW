...
def check_for_marker():
    """Check camera feed for a short time to see if marker is visible"""
    global marker_found
    marker_found = False
    ...
    # Check for marker for 3 seconds
    start_time = time.time()
    while time.time() - start_time < 3 and not marker_found:
        time.sleep(0.1)
...
def search_pattern():
    """Execute search pattern: left 30s, forward 30s, right 30s, back 30s"""
    
    # Move LEFT for 30 seconds
    print("Moving LEFT for 30 seconds...")
    send_local_ned_velocity(0, velocity, 0)  # velocity = -0.5 (left)
    time.sleep(40)
    
    # Stop and check for marker
    send_local_ned_velocity(0, 0, 0)
    time.sleep(0.5)
    if check_for_marker():
        print("Marker found after LEFT move!")
        return True
    
    # Move FORWARD for 30 seconds
    print("Marker not found. Moving FORWARD for 30 seconds...")
    send_local_ned_velocity(-velocity, 0, 0)  # positive X = forward in NED body frame
    time.sleep(45)
    ...
    time.sleep(0.5)
    if check_for_marker():
        print("Marker found after FORWARD move!")
        return True
    
    # Move RIGHT for 30 seconds
    print("Marker not found. Moving RIGHT for 30 seconds...")
    send_local_ned_velocity(0, -velocity, 0)  # positive Y = right
    time.sleep(30)
    ...
    time.sleep(0.5)
    if check_for_marker():
        print("Marker found after RIGHT move!")
        return True
    
    # Move BACK for 30 seconds (return to original position)
    print("Marker not found. Moving BACK for 30 seconds to return to start...")
    send_local_ned_velocity(velocity, 0, 0)  # negative X = backward
    time.sleep(30)
    ...
    time.sleep(0.5)
    if check_for_marker():
        print("Marker found after BACK move!")
        return True
    
    print("Search pattern complete. Marker not found.")
    return False
